          ...
          return (
            ...
            >
              {showTooltip && isHovered && (
                <div className="absolute bottom-full mb-2 px-3 py-2 bg-surface-1/95 backdrop-blur-xl border border-white/[0.08] text-ink-0 text-xs font-mono font-medium rounded-lg shadow-lg whitespace-nowrap z-10 animate-fade-in-up">
              ...
              <div
                className={`w-full rounded-t-lg transition-all duration-300 ${
                  point.color || 'bg-gradient-to-t from-brand-500 to-accent-500'
                } ${isHovered ? 'opacity-100 shadow-glow-brand' : 'opacity-90'}`}
                style={{
